...
INSERT INTO books (
    ...
    ('9780140449156', 'Classic', 'Geoffrey Chaucer', 'The Canterbury Tales', -- adding of a book with a future release date in order to test coming soon feature, remove as needed
    'img/canterbury_tales.jpg', '1st', 'Penguin Classics', 2026, 15, 3, 5.50, 9.99, 4.9, TRUE, '2026-01-01')
